...
export default {
  ...
  created() {
    ...
    // console.log('daa_account_id',this.$route);
    if(pageCount){
  ...
  mounted() {
    ...
    listData() {		
      ...
      this.daa_account_id = this.$route.query.account_id
      this.loading = true
      let params = {
        page: currentPage,
        ...
        time_unit: this.$route.query.time_unit || '',
        ...
        daa_account_id: this.daa_account_id,
        show_type: 'all'
      }
